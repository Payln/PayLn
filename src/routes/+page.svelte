...
<div class="max-w-[1024px] mx-auto">
	...
	<div class="flex lg:flex-row flex-col">
		<div
			id="fix"
			class="flex gap-6 flex-row max-w-[738px] lg:max-w-none w-[75%] lg:w-1/2 flex-wrap justify-around content-around text-center mx-auto md:mx-4"
		>
			{#each blocks as block}
				<div
					class="text-xl border-2 bg-white border-gray-200 rounded-lg drop-shadow-[0_35px_35px_rgb(34,61,91,0.10)] p-2 md:p-4 w-[10rem]"
				>
					<span class="text-[#223d5b]">
						<i class={block.icon} />
					</span>
					<p>
						{block.title}
		...
		<div
			class="lg:w-[40vw] w-1/2 my-10 mx-auto lg:my-auto border drop-shadow-[0_35px_35px_rgb(34,61,91,0.10)]"
		>
	...
	<!--  -->
	<div
		class="mt-16 bg-[#223d5b] block w-[75%] mx-auto px-16 pb-16 text-white border border-gray-200"
	>
		<div class="flex felx-row">
			<h5 class="mb-2 text-2xl font-bold my-12">E-Commerce</h5>
		</div>
		<!--  -->
		<h5 class="mb-2 sm:text-5xl text-3xl font-bold my-12">The best way to accept payments</h5>
		...
		<div class="pt-[4rem] grid grid-cols-2 gap-6">
			...
			<p>
				<i class="fa-solid fa-shield-halved pr-2" />Eliminate fraud — No chargebacks or Identity
				theft
			</p>
	...
	<!--  -->
	<footer class="bg-white shadow md:shadow-none">
...
<style>
	@media screen and (min-width: 720px) and (max-width: 1026px) {
		#fix {
			width: 60%;
			margin: 0 auto;
		}
